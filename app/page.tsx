...
const skillGroups = [
  ...
  ["Active Directory", "Azure AD / Entra ID", "IAM", "SSO", "M365 Admin", "DNS", "DHCP"],
  ["SharePoint", "Exchange Online", "Teams", "Enterprise Troubleshooting", "Windows & macOS Support"],
  ["React.js", "Next.js", "Node.js", "Express.js", "Figma", "Adobe XD", "WordPress", "Accessibility", "REST APIs", "Git", "GitHub", "Vercel"]
];

const certifications = [
  { company: "Google", name: "Google AI Professional", description: "Applied AI and modern product development skills with a strong focus on responsible implementation and practical workflows." },
  { company: "IBM", name: "IBM AI Developer", description: "Training in building AI-enabled solutions and applying core development practices in real-world projects." },
  { company: "Google", name: "Fundamentals of Digital Marketing", description: "Foundational digital marketing knowledge covering strategy, growth thinking, and online campaign fundamentals." }
];
...
export default function Home() {
  ...
  return <main>
    <CustomCursor /><section className="hero" id="top"><ParticleField /><nav><a href="#top" className="brand">Parth<span>®</span></a><div className="nav-links"><a href="#archive">Experience</a><a href="#lab">Work</a><a href="#certifications">Certifications</a><a href="#contact">Contact</a></div><a href="mailto:parthmishra1303@gmail.com" className="availability"><i /> Available for select work</a></nav>
      <div className="hero-content"><motion.p className="eyebrow hero-kicker" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .2 }}>Independent digital practice / 2026</motion.p><motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: .25, ease: [0.22, 1, 0.36, 1] }}>Software engineer, IT infrastructure specialist, and UI/UX designer shaping <em>reliable digital experiences</em>.</motion.h1><motion.div className="hero-bottom" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: .8, delay: .65 }}><p>Versatile software &amp; corporate IT engineer combining full-stack development, high-fidelity UI design, and secure enterprise infrastructure capabilities across Microsoft 365, Azure AD, and modern web platforms.</p><div className="hero-actions"><a className="button button-primary" href="#archive">Explore Experience <span>↓</span></a><a className="button" href="#certifications">View Certifications <span>↗</span></a></div></motion.div></div><a className="scroll-cue" href="#archive"><span /> Scroll to explore</a>
    </section>
    ...
    <section id="archive" className="section experience"><motion.div {...reveal} className="section-heading"><p className="eyebrow">01 / Professional experience</p><h2>Building <em>reliable systems</em> and polished products.</h2><p>From enterprise IT operations to high-fidelity web experiences, I bring a cross-functional approach that balances engineering rigor, security, and user-centered design.</p></motion.div>
      <div className="timeline"><motion.article {...reveal} className="experience-card"><div className="timeline-dot" /><p className="experience-date">May 2026 — Present</p><div className="experience-main"><p className="eyebrow">Orion Services Pvt. Ltd. | Bengaluru, India</p><h3>Junior Software &amp; IT Infrastructure Engineer</h3><ul><li><strong>Web Infrastructure &amp; Networking</strong> — Achieved 99.9% uptime and reduced page load latency by 32% through optimized build pipelines, monitoring, and DNS/DHCP improvements.</li><li><strong>Identity &amp; Cloud Access</strong> — Administered Active Directory and Azure AD environments, configuring SSO, user lifecycle controls, and security group governance.</li><li><strong>M365 &amp; Support</strong> — Managed SharePoint, Exchange Online, Teams policies, and delivered tier-2 support for Windows and macOS devices.</li><li><strong>UI/UX Workflows</strong> — Created high-impact corporate assets in Figma and Adobe XD, increasing design-to-development handoff efficiency by 35%.</li></ul></div><p className="experience-index">01</p></motion.article>
        <motion.article {...reveal} transition={{ ...reveal.transition, delay: .13 }} className="experience-card"><div className="timeline-dot" /><p className="experience-date">Sep 2021 — Feb 2024</p><div className="experience-main"><p className="eyebrow">11x Infisol | Bhubaneswar, India</p><h3>Part-Time Frontend Developer</h3><ul><li><strong>Responsive UI Architecture</strong> — Engineered responsive interfaces and reusable React components, increasing code reusability by 40% and reducing frontend bugs by 20%.</li><li><strong>WordPress &amp; CMS Delivery</strong> — Built and maintained WordPress-based pages and content workflows, helping ship client-facing updates faster and more consistently.</li><li><strong>Delivery Velocity</strong> — Accelerated deployment speed by 25% across 12 sprints through collaborative agile development and clear implementation planning.</li></ul></div><p className="experience-index">02</p></motion.article>
        <motion.article {...reveal} transition={{ ...reveal.transition, delay: .2 }} className="experience-card"><div className="timeline-dot" /><p className="experience-date">Feb 2021 — Aug 2021</p><div className="experience-main"><p className="eyebrow">11x Infisol | Bhubaneswar, India</p><h3>Frontend Developer Intern</h3><ul><li><strong>Navigation Systems</strong> — Built user-centered navigation flows that improved task completion rates by 30% and reduced bounce rates by 15%.</li><li><strong>Accessible Wireframes</strong> — Translated early wireframes into accessible interaction patterns that strengthened the foundation for later product growth.</li></ul></div><p className="experience-index">03</p></motion.article></div>
    </section>
    ...
    <section className="section skills"><motion.div {...reveal} className="skills-top"><div className="section-heading"><p className="eyebrow">03 / Skills matrix</p><h2>Fluent across <em>the stack</em> and the enterprise.</h2></div><p className="skills-note">From modern web engineering to secure corporate operations, each capability is applied with precision and practicality.</p></motion.div><div className="skills-grid">{skillGroups.map((group, groupIndex) => <motion.div {...reveal} transition={{ ...reveal.transition, delay: groupIndex * .08 }} className="skill-cluster" key={group[0]}><p className="eyebrow">{["Engineering", "Enterprise IT", "Cloud & Infra", "Design / Tools"][groupIndex]}</p><div className="skill-list">{group.map((skill) => <span className="skill" key={skill}><i aria-hidden="true">✦</i>{skill}</span>)}</div></motion.div>)}</div>
    </section>

    <section id="certifications" className="section certifications"><motion.div {...reveal} className="section-heading section-heading-wide"><p className="eyebrow">04 / Certifications</p><h2>Recognized for <em>applied expertise.</em></h2><p>Credentials that reflect a blend of AI fluency, software delivery, and digital growth mindset.</p></motion.div><div className="certifications-grid">{certifications.map((item, index) => <motion.article {...reveal} transition={{ ...reveal.transition, delay: index * .08 }} className="certification-card" key={item.name}><div className={`certification-badge certification-badge-${item.company.toLowerCase() === "google" ? "google" : item.company.toLowerCase() === "ibm" ? "ibm" : "digital"}`} aria-hidden="true">{item.company === "Google" ? "G" : item.company === "IBM" ? "IBM" : item.company.slice(0, 2).toUpperCase()}</div><div><p className="eyebrow">{item.company}</p><h3>{item.name}</h3><p>{item.description}</p></div></motion.article>)}</div>
    </section>

    <footer id="contact"><div className="footer-glow" /><motion.div {...reveal} className="contact-top"><p className="eyebrow">05 / Start a conversation</p><h2>Let’s build something <em>exceptional.</em></h2><a className="email-link" href="mailto:parthmishra1303@gmail.com">parthmishra1303@gmail.com <span>↗</span></a></motion.div><div className="terminal"><div className="terminal-bar"><span /><span /><span /><p>connection_status</p></div><p><b>~/partha</b> <span className="terminal-prompt">$</span> location --check</p><p className="terminal-output">Location: Bengaluru, India</p><p><b>~/partha</b> <span className="terminal-prompt">$</span> availability --now</p><p className="terminal-output">Active Status: <strong>Open to Innovation</strong><i /></p></div><div className="footer-bottom"><p>© 2026 Partha Sarathi Mishra</p><div><a href="https://www.linkedin.com/in/parthmishrra" target="_blank">LinkedIn</a><a href="https://github.com/Parthmishrra" target="_blank">GitHub</a></div><a href="#top">Back to top ↑</a></div></footer>
  </main>;
}
